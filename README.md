...
- [FLIP: Fine-grained Alignment between ID-based Models and Pretrained Language Models for CTR Prediction](http://arxiv.org/abs/2310.19453)  
- [Contrastive Learning with Frequency-Domain Interest Trends for Sequential Recommendation (RecSys 2023)](https://dl.acm.org/doi/10.1145/3604915.3608790)  
- [MMOE: Multi-gate Mixture-of-Experts for Multi-Task Learning](https://arxiv.org/abs/2311.09580)
